...
def html(config, sh_file, name):
    ...
    commands.append("/data_center_01/home/mas/python3.6/bin/python3 %s/json_structure/parse_html.py -j %s/json_structure/json_structure.json -t %s/json_structure/html_material/html_templates/ -o %s/result/html/"\
